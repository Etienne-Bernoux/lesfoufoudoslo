...
public class _ProfilerStub extends org.omg.CORBA.portable.ObjectImpl implements profileapp.Profiler
{
  ...
  public profileapp.User getUserProfile (String user_id, String song_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (song_id);
                $in = _invoke ($out);
                profileapp.User $result = profileapp.UserHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                ...
                return getUserProfile (user_id, song_id        );
            } finally {
                _releaseReply ($in);
            }
  } // getUserProfile
  ...
  public profileapp.TopTen getTopTenUsers ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getTopTenUsers", true);
                $in = _invoke ($out);
                profileapp.TopTen $result = profileapp.TopTenHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
